export interface DistrictContent {
    cards: { image: string; title: string; text: string; alt: string; fallbackImage?: string }[]
    travel: { destination: string; image: string; description: string; bestTime: string; tip: string; fallbackImage?: string }[]
    tips: string[]
}
...
const WIKI = (path: string) => `https://upload.wikimedia.org/wikipedia/commons/thumb/${path}`

export const DISTRICT_CONTENT: Record<string, DistrictContent> = {

    Bagalkote: {
        cards: [
            { image: WIKI('e/e5/7th_to_8th_century_Bhutanatha_temple%2C_Badami_Karnataka_2.jpg/1280px-7th_to_8th_century_Bhutanatha_temple%2C_Badami_Karnataka_2.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Badami Cave Temples', text: 'Carved into sandstone cliffs, the 6th-century cave temples of Badami showcase exquisite Chalukya artistry. Four caves dedicated to Hindu and Jain deities reveal intricate sculptures that have endured twelve centuries.', alt: 'Badami cave temple sandstone cliffs' },
            { image: WIKI('6/6d/Virupaksha_temple_at_Pattadakal.jpg/1280px-Virupaksha_temple_at_Pattadakal.jpg'), fallbackImage: 'https://images.pexels.com/photos/29833608/pexels-photo-29833608.jpeg?auto=compress&cs=tinysrgb&w=1200', title: 'Pattadakal Heritage', text: 'A UNESCO World Heritage site, Pattadakal\'s nine Hindu temples blend northern and southern Indian architecture. The Virupaksha Temple\'s towering vimana dominates the skyline along the Malaprabha River.', alt: 'Pattadakal temple complex heritage' },
            { image: WIKI('6/64/Scenic_view_a_rare_apsidal_Durga_Temple.jpg/1280px-Scenic_view_a_rare_apsidal_Durga_Temple.jpg'), fallbackImage: 'https://images.pexels.com/photos/5497596/pexels-photo-5497596.jpeg?auto=compress&cs=tinysrgb&w=1200', title: 'Aihole\'s Experimental Ground', text: 'Known as the "Cradle of Indian Architecture," Aihole houses over 125 temples spanning centuries. The Durga Temple\'s apsidal plan and the Lad Khan Temple\'s unique design showcase bold architectural experimentation.', alt: 'Aihole ancient temple architecture' },
        ],
        travel: [
            { destination: 'Badami Cave Complex', image: IMG('photo-1464822759023-fed622ff2c3b'), description: 'Explore four rock-cut caves dating to the Chalukya dynasty, each adorned with detailed carvings of Hindu deities, dancing figures, and Jain Tirthankaras.', bestTime: 'October to March', tip: 'Visit Cave 3 first — it has the largest and most intricate carvings' },
    ...
    Ballari: {
        cards: [
            { image: WIKI('b/ba/Iconic_Stone_Chariot_%40_Vittala_Temple%2C_Hampi%2C_Karnataka.jpg/1280px-Iconic_Stone_Chariot_%40_Vittala_Temple%2C_Hampi%2C_Karnataka.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Hampi\'s Vijayanagara Glory', text: 'Once the wealthiest city in India, Hampi\'s 1,600+ ruins sprawl across a surreal boulder-strewn landscape. The Vittala Temple\'s stone chariot and musical pillars epitomize Vijayanagara craftsmanship.', alt: 'Hampi ruins boulder landscape' },
            { image: IMG('photo-1506744038136-46273834b3fb'), title: 'Sunset at Matanga Hill', text: 'The highest point in Hampi offers panoramic views of the ruined city at golden hour. As the sun sinks behind the granite boulders, the entire valley glows in amber light.', alt: 'Sunset Matanga Hill Hampi view' },
        ...
        travel: [
            ...
            { destination: 'Vittala Temple Complex', image: WIKI('2/27/StoneChariot-Hampi-Karnataka-002.jpg/1280px-StoneChariot-Hampi-Karnataka-002.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505144808419-1957a94ca61e?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Hampi\'s crown jewel featuring the iconic stone chariot, musical pillars that ring when tapped, and the magnificent Ranga Mantapa.', bestTime: 'November to February', tip: 'Tap the pillars gently — each produces a different musical note' },
    ...
    Belagavi: {
        cards: [
            { image: WIKI('3/3c/General_view_of_the_gateway_of_the_fort%2C_Belgaum.jpg/1280px-General_view_of_the_gateway_of_the_fort%2C_Belgaum.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Belagavi Fort Heritage', text: 'The 12th-century Belagavi Fort, built by the Rattas, has witnessed centuries of warfare. Its hexagonal plan, moat, and the Kamal Basadi Jain temple within tell tales of successive dynasties.', alt: 'Belagavi fort architecture' },
            { image: WIKI('3/32/Gokak_Falls_karnataka.jpg/1280px-Gokak_Falls_karnataka.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1764618979779-f5a8abf6ab28?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Waterfalls of the Region', text: 'Around Belagavi, waterfalls like Gokak Falls — a 52-metre cascade on the Ghataprabha River — thunder during the monsoon, creating rainbows in the mist.', alt: 'Gokak falls waterfall monsoon' },
        ...
        travel: [
            { destination: 'Gokak Falls', image: WIKI('3/32/Gokak_Falls_karnataka.jpg/1280px-Gokak_Falls_karnataka.jpg'), fallbackImage: 'https://images.pexels.com/photos/18082819/pexels-photo-18082819.jpeg?auto=compress&cs=tinysrgb&w=1200', description: 'A horseshoe-shaped waterfall plunging 52 metres, often called the "Niagara of Karnataka." The hanging bridge offers a thrilling view.', bestTime: 'July to September', tip: 'Visit after heavy rainfall for the most dramatic waterfall volume' },
    ...
    BengaluruRural: {
        cards: [
            ...
            { image: WIKI('7/75/Devanahalli_Fort_entrance%2C_Devanahalli%2C_Bengaluru%2C_Karnataka%2C_India_%282006%29.jpg/1280px-Devanahalli_Fort_entrance%2C_Devanahalli%2C_Bengaluru%2C_Karnataka%2C_India_%282006%29.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Devanahalli Fort', text: 'The birthplace of Tipu Sultan, this 15th-century fort features imposing granite walls and a temple dedicated to Lord Venugopala. The adjacent town retains old-world charm.', alt: 'Devanahalli fort Tipu Sultan' },
    ...
    BengaluruUrban: {
        cards: [
            { image: WIKI('8/8f/Bangalore_Mysore_Maharaja_Palace.jpg/1280px-Bangalore_Mysore_Maharaja_Palace.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600100393203-5ba9541df13c?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Bengaluru Palace', text: 'A Tudor-style palace built in 1887, inspired by Windsor Castle. Its manicured grounds, Gothic windows, and ornate woodwork offer a surprising slice of British royalty in the Garden City.', alt: 'Bengaluru Palace Tudor architecture' },
            { image: WIKI('7/77/Glass_house%2C_Lalbagh_botanical_garden%2C_Bangalore.jpg/1280px-Glass_house%2C_Lalbagh_botanical_garden%2C_Bangalore.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Lalbagh\'s Green Legacy', text: 'Founded by Hyder Ali in 1760, Lalbagh Botanical Gardens spans 240 acres with 1,800+ species. The glass house, modelled on London\'s Crystal Palace, hosts biannual flower shows.', alt: 'Lalbagh glass house garden' },
            { image: WIKI('d/d1/Cubbon_Park_Bengaluru_Karnataka_India_1.jpg/1280px-Cubbon_Park_Bengaluru_Karnataka_India_1.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1771250851493-a156fb0a6b85?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Cubbon Park Walks', text: 'An urban oasis of 300 acres in the heart of the city. Winding paths under century-old trees, statues of luminaries, and the State Central Library make it a cultural hub.', alt: 'Cubbon Park trees walkway' },
        ],
        travel: [
            { destination: 'Bangalore Palace', image: WIKI('8/8f/Bangalore_Mysore_Maharaja_Palace.jpg/1280px-Bangalore_Mysore_Maharaja_Palace.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'A magnificent Tudor-style palace with fortified turrets, graceful arches, and exquisite woodcarvings spanning 45,000 square feet of royal heritage.', bestTime: 'October to March', tip: 'The palace hosts concerts and events — check the schedule in advance' },
    ...
    Bidar: {
        cards: [
            { image: WIKI('8/82/Bidar_Fort_%28outside_view%29.jpg/1280px-Bidar_Fort_%28outside_view%29.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1775489876620-6611994afd43?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Bidar Fort\'s Majesty', text: 'One of India\'s largest forts, Bidar Fort sprawls over 10 square kilometres. Its unique Islamic architecture, intricate tile work, and the Rangin Mahal\'s Persian inscriptions showcase Bahmani grandeur.', alt: 'Bidar Fort Islamic architecture' },
            { image: IMG('photo-1775489876620-6611994afd43'), title: 'Madrasa of Mahmud Gawan', text: 'A 15th-century Islamic college that was once a leading centre of learning in Asia. Its three-storey facade, minarets, and colourful tiles reflect Timurid influence in the Deccan.', alt: 'Madrasa Mahmud Gawan Bidar' },
        ...
        travel: [
            { destination: 'Bidar Fort', image: WIKI('8/82/Bidar_Fort_%28outside_view%29.jpg/1280px-Bidar_Fort_%28outside_view%29.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Explore the royal palaces, audience halls, and underground water systems of this sprawling Bahmani fort. The Solah Khamba Mosque is a masterpiece.', bestTime: 'October to March', tip: 'The fort\'s underground chambers maintain a cool temperature year-round' },
    ...
    Chamarajanagara: {
        cards: [
            { image: WIKI('5/5f/BR_Hills_Banana_Fields_Hondarabalu_Karnataka_May24_A7CR_00064.jpg/1280px-BR_Hills_Banana_Fields_Hondarabalu_Karnataka_May24_A7CR_00064.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1511497584788-876760111969?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Biligirirangan Hills', text: 'The BR Hills form a unique biological bridge between the Western and Eastern Ghats. This tiger reserve shelters elephants, gaurs, and leopards amid shola forests and grasslands.', alt: 'BR Hills forest tiger reserve' },
            ...
            { image: WIKI('2/20/Kabini_river_Karnataka_India.jpg/1280px-Kabini_river_Karnataka_India.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1771518701790-9094cc6bd106?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'River Kapila\'s Course', text: 'The Kapila River (Kabini) forms the district\'s southern boundary, creating rich riparian habitats. Boat safaris on the river offer close encounters with wildlife.', alt: 'Kabini river wildlife safari' },
        ],
        travel: [
    ...
    Chikkaballapura: {
        cards: [
            { image: WIKI('2/23/Nandi_hills_top_view.jpg/1280px-Nandi_hills_top_view.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Nandi Hills Majesty', text: 'The crown jewel of Chikkaballapura, Nandi Hills offers ancient hilltop temples, Tipu Sultan\'s summer palace, and sunrise views that reveal the entire Deccan plateau stretching endlessly.', alt: 'Nandi Hills sunrise panorama' },
        ...
        travel: [
            { destination: 'Nandi Hills', image: IMG('photo-1769755503719-bcb034b02bfd'), description: 'The historic hill fortress with temples, a palace, and stunning viewpoints. Yoga and meditation retreats are popular at the hilltop.', bestTime: 'October to March', tip: 'The Yoga centre on the hill offers classes with a view' },
    ...
    Chikkamagaluru: {
        cards: [
            { image: WIKI('3/37/Shade_coffee_plantation_landscape_Chikmagalur.jpg/1280px-Shade_coffee_plantation_landscape_Chikmagalur.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Coffee Country', text: 'Chikkamagaluru is the birthplace of Indian coffee. The misty slopes of the Mullayanagiri range host sprawling estates where arabica and robusta thrive under silver oak shade.', alt: 'Coffee plantation Chikkamagaluru' },
            { image: WIKI('2/25/Mullayanagiri_in_Chikmagalur_district_of_Karnataka.jpg/1280px-Mullayanagiri_in_Chikmagalur_district_of_Karnataka.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Mullayanagiri Peak', text: 'At 1,930 metres, Mullayanagiri is Karnataka\'s highest peak. The trek to the summit passes through shola forests and grasslands, rewarding hikers with a breathtaking 360-degree panorama.', alt: 'Mullayanagiri peak trek view' },
            { image: WIKI('8/87/Hebbe_Falls_Chikmagalur_India.jpg/1280px-Hebbe_Falls_Chikmagalur_India.jpg'), fallbackImage: 'https://images.pexels.com/photos/18082819/pexels-photo-18082819.jpeg?auto=compress&cs=tinysrgb&w=1200', title: 'Hebbe Falls Descent', text: 'A 168-metre two-tiered waterfall that cascades through coffee plantations. The trek to Hebbe Falls is as rewarding as the destination, with spice-scented air guiding the way.', alt: 'Hebbe falls waterfall coffee estate' },
        ],
        travel: [
    ...
    Chitradurga: {
        cards: [
            { image: WIKI('0/0e/The_magnificent_fort_of_Chitradurga.jpg/1280px-The_magnificent_fort_of_Chitradurga.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: "Chitradurga Fort's Seven Walls", text: 'Built across 1,500 years, this massive fort features seven concentric walls, 19 gateways, and a sophisticated water harvesting system. The fort\'s Kannada name means "picturesque fort."', alt: 'Chitradurga fort walls' },
    ...
    DakshinaKannada: {
        cards: [
            { image: WIKI('4/48/Tannirbavi_beach%2C_Mangaluru%2C_Karnataka%2C_India.jpg/1280px-Tannirbavi_beach%2C_Mangaluru%2C_Karnataka%2C_India.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Mangalore\'s Coastal Charm', text: 'Mangalore, the district headquarters, blends coastal tradition with modernity. Its red-tiled roofs, coconut groves, and the rhythmic chant of Konkani hymns define the city\'s soul.', alt: 'Mangalore coastal city' },
            { image: WIKI('5/54/Mangaladevi_Temple_entrance%2C_Mangaladevi%2C_Mangalore.jpg/1280px-Mangaladevi_Temple_entrance%2C_Mangaladevi%2C_Mangalore.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Temples of the Coast', text: 'Dakshina Kannada is home to the famed Krishna Temple at Udupi, the Mangaladevi Temple, and the Kollur Mookambika Temple — each a masterpiece of Kerala-style architecture.', alt: 'Mangaladevi temple Mangalore' },
            { image: WIKI('8/8e/Pilikula_Nisargadhama.jpg/1280px-Pilikula_Nisargadhama.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505144808419-1957a94ca61e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Pilikula Nisargadhama', text: 'A 358-acre eco-tourism complex featuring a zoo, botanical garden, and lake. The Pilikula Heritage Village showcases the distinct culture of Tulu Nadu.', alt: 'Pilikula botanical garden lake' },
        ],
        travel: [
    ...
    Dharwad: {
        cards: [
            ...
            { image: WIKI('c/c3/Administration_building%2C_Karnatak_University%2C_Dharwad%2C_Karnataka%2C_India_%282007%29.jpg/1280px-Administration_building%2C_Karnatak_University%2C_Dharwad%2C_Karnataka%2C_India_%282007%29.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Karnataka University Campus', text: 'One of India\'s most beautiful university campuses, spread over 500 acres of wooded land. The architecture blends Indo-Saracenic and modern styles amid landscaped gardens.', alt: 'Karnataka University Dharwad campus' },
            { image: WIKI('7/77/Unkal_lake.jpg/1280px-Unkal_lake.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1769755503719-bcb034b02bfd?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Unkal Lake Serenity', text: 'A picturesque lake with a musical fountain and landscaped gardens. The sunset views from the lakeside promenade are a favourite among locals and visitors alike.', alt: 'Unkal lake Dharwad sunset' },
        ],
        travel: [
    ...
    Gadag: {
        cards: [
            { image: WIKI('5/51/Dravidian_Gopura_of_Veeranarayana_temple%2C_Gadag.jpg/1280px-Dravidian_Gopura_of_Veeranarayana_temple%2C_Gadag.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Veeranarayana Temple', text: 'Gadag\'s crowning glory, this 12th-century temple is a masterpiece of Kalyani Chalukya architecture. The temple\'s ornate pillars and intricate ceiling carvings are a testament to ancient craftsmanship.', alt: 'Veeranarayana temple Gadag' },
    ...
    Hassan: {
        cards: [
            { image: WIKI('c/c1/Chennakeshava_Temple_at_Belur.jpg/1280px-Chennakeshava_Temple_at_Belur.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600100393203-5ba9541df13c?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Belur\'s Chennakeshava Temple', text: 'Hoysala architecture at its zenith — this 12th-century temple at Belur took 103 years to complete. Every inch of the exteriors is covered in intricate friezes of gods, dancers, and mythical creatures.', alt: 'Chennakeshava temple Belur' },
            { image: WIKI('8/81/Halebid_Hoysaleshwara_temple_interior.JPG/1280px-Halebid_Hoysaleshwara_temple_interior.JPG'), fallbackImage: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Halebidu\'s Hoysaleswara Temple', text: 'Though never completed, this temple is considered the finest example of Hoysala architecture. The Nandi pavilion houses a magnificent 3.6-metre bull carved from a single stone.', alt: 'Hoysaleswara temple Halebidu' },
    ...
    Haveri: {
        cards: [
            { image: IMG('photo-1600100393203-5ba9541df13c'), title: 'Siddheshwara Temple', text: 'Built in the 11th century by the Kalyani Chalukyas, this temple at Haveri features a unique blend of early Hoysala and Chalukya styles. The sculpted Nandi is exceptionally detailed.', alt: 'Siddheshwara temple Haveri' },
        ...
        travel: [
            { destination: 'Siddheshwara Temple', image: IMG('photo-1600100393203-5ba9541df13c'), description: 'An 11th-century architectural wonder with a beautifully carved Nandi mandapa and intricate ceiling panels depicting floral and geometric patterns.', bestTime: 'October to February', tip: 'The temple\'s polished black stone pillars are cool to touch even in summer' },
    ...
    Kalaburagi: {
        cards: [
            { image: WIKI('a/ac/The_Gulbarga_Fort_is_located_in_Gulbarga_City_in_the_Gulbarga_district_of_North_Karnataka_india.jpg/1280px-The_Gulbarga_Fort_is_located_in_Gulbarga_City_in_the_Gulbarga_district_of_North_Karnataka_india.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1775489876620-6611994afd43?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Gulbarga Fort\'s Grandeur', text: 'Built in the 14th century and later strengthened by the Bahmani Sultanate, Gulbarga Fort\'s 37 bastions and 15 gates encircle a fascinating blend of Islamic and Hindu architecture.', alt: 'Gulbarga fort bastions' },
            { image: PEX(32089411), title: 'Jama Masjid\'s Persian Soul', text: 'Inspired by the Great Mosque of Cordoba, this 14th-century mosque inside the fort is one of India\'s largest. Its 75 domes and 250 arches create a forest of geometric harmony.', alt: 'Jama Masjid Gulbarga domes' },
        ...
        travel: [
            { destination: 'Gulbarga Fort', image: WIKI('a/ac/The_Gulbarga_Fort_is_located_in_Gulbarga_City_in_the_Gulbarga_district_of_North_Karnataka_india.jpg/1280px-The_Gulbarga_Fort_is_located_in_Gulbarga_City_in_the_Gulbarga_district_of_North_Karnataka_india.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Explore the massive fort with its unique blend of architectural styles. The Allah-ud-din Bahmani Mosque within is one of India\'s finest examples of Persian architecture.', bestTime: 'October to March', tip: 'The fort\'s underground passages are a must-explore (carry a torch)' },
    ...
    Kodagu: {
        cards: [
            ...
            { image: WIKI('f/f6/ABBEY_FALLS_%2CCOORG_%2CKARNATAKA.jpg/1280px-ABBEY_FALLS_%2CCOORG_%2CKARNATAKA.jpg'), fallbackImage: 'https://images.pexels.com/photos/25841472/pexels-photo-25841472.jpeg?auto=compress&cs=tinysrgb&w=1200', title: 'Abbey Falls\' Monsoon Roar', text: 'Plunging 70 metres through coffee plantations, Abbey Falls is at its most spectacular during the monsoon. The walkway through spice gardens adds to the experience.', alt: 'Abbey falls Coorg waterfall' },
            { image: WIKI('3/34/Nagarhole_National_Park%2C_Karnataka.jpg/1280px-Nagarhole_National_Park%2C_Karnataka.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1511497584788-876760111969?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Nagarahole Tiger Reserve', text: 'Part of the Nilgiri Biosphere Reserve, Nagarahole shelters India\'s highest tiger density. Kabini\'s backwaters offer unmatched wildlife viewing from boat safaris.', alt: 'Nagarahole tiger reserve safari' },
        ],
        travel: [
            { destination: 'Raja\'s Seat', image: IMG('photo-1771250851493-a156fb0a6b85'), description: 'The "King\'s Seat" is a viewpoint commanding a panoramic sweep of the Western Ghats. Sunrise and sunset from this spot are legendary.', bestTime: 'October to March', tip: 'Arrive 30 minutes before sunrise for the best experience' },
    ...
    Kolar: {
        cards: [
            ...
            { image: WIKI('4/40/Profile_of_shrine_and_sikhara_in_Someshwara_temple_at_Kolar.jpg/1280px-Profile_of_shrine_and_sikhara_in_Someshwara_temple_at_Kolar.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600100393203-5ba9541df13c?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Kolaramma Temple', text: 'A 9th-century Chola temple dedicated to the goddess Kolaramma. The temple\'s unique sculptural panels and the 1,000-pillar mantapa showcase Chola artistry far from Tamil Nadu.', alt: 'Kolaramma temple Chola architecture' },
    ...
    Koppal: {
        cards: [
            { image: WIKI('6/67/Gagan_Mahal_palace%2C_Anegundi.jpg/1280px-Gagan_Mahal_palace%2C_Anegundi.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Hampi\'s Other Half', text: 'Koppal district shares the Hampi heritage area. The Anegundi village across the Tungabhadra is believed to be the mythical Kishkindha from the Ramayana.', alt: 'Anegundi Hampi Kishkindha' },
            { image: IMG('photo-1748671631643-87e9ce7aa917'), title: 'Koppal Fort\'s Stratigraphy', text: 'The fort atop a massive hill reveals layers of history — from the Vijayanagara Empire to the Bijapur Sultanate and the British Raj. The climb rewards with 360-degree views.', alt: 'Koppal fort hill view' },
            { image: WIKI('d/d9/Mahadeva_Temple_at_Itagi_in_the_Koppal_district.JPG/1280px-Mahadeva_Temple_at_Itagi_in_the_Koppal_district.JPG'), fallbackImage: 'https://images.unsplash.com/photo-1511497584788-876760111969?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Mahadeva Temple at Itagi', text: 'Described as "the emperor of all Chalukya temples," this 12th-century masterpiece at Itagi features exquisite carvings, a massive Nandi, and a beautifully proportioned vimana.', alt: 'Mahadeva temple Itagi' },
        ],
        travel: [
            { destination: 'Anegundi', image: IMG('photo-1505144808419-1957a94ca61e'), description: 'Older than Hampi, Anegundi is believed to be the monkey kingdom of Kishkindha. Explore the ancient fort, the Pampa Sarovar, and the Anjanadri Hill.', bestTime: 'October to March', tip: 'Anjanadri Hill is believed to be the birthplace of Hanuman' },
            { destination: 'Mahadeva Temple, Itagi', image: IMG('photo-1600100393203-5ba9541df13c'), description: 'A pinnacle of Western Chalukya architecture with exquisite sculptures. The temple\'s inscription describes it as "the emperor of temples."', bestTime: 'November to February', tip: 'The carving of the Nandi at the entrance is remarkably lifelike' },
    ...
    Mandya: {
        cards: [
            { image: IMG('photo-1464822759023-fed622ff2c3b'), title: 'Sugarcane Country', text: 'Mandya is called the "Sugar Bowl of Karnataka." Endless fields of sugarcane sway across the district, fed by the Krishna Raja Sagara dam and its network of canals.', alt: 'Sugarcane fields Mandya' },
            { image: WIKI('b/b7/Tipu_Sultan%27s_Summer_Palace%2C_Srirangapatna%2C_Karnataka.jpg/1280px-Tipu_Sultan%27s_Summer_Palace%2C_Srirangapatna%2C_Karnataka.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Srirangapatna\'s Royal Past', text: 'The island fortress of Srirangapatna was the capital of Tipu Sultan\'s kingdom. The Ranganathaswamy Temple, Dariya Daulat Palace, and Tipu\'s summer palace dot the island.', alt: 'Srirangapatna Tipu palace' },
            { image: WIKI('f/fa/Krishna_Raja_Sagara_Dam_%281%29.jpg/1280px-Krishna_Raja_Sagara_Dam_%281%29.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600100393203-5ba9541df13c?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Krishna Raja Sagara Dam', text: 'The iconic KRS Dam, built in 1931, is a marvel of engineering. The Brindavan Gardens below it are illuminated on weekends, creating a wonderland of lights and fountains.', alt: 'KRS dam Brindavan Gardens' },
        ],
        travel: [
            ...
            { destination: 'Melukote', image: WIKI('b/bb/Melukote_Kalyani%2C_Karnataka%2C_India.jpg/1280px-Melukote_Kalyani%2C_Karnataka%2C_India.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1764618979779-f5a8abf6ab28?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'A historic hill-town with the Cheluvanarayana Swamy Temple and the Academy of Sanskrit Research. The panoramic view from the hilltop is spectacular.', bestTime: 'October to February', tip: 'The temple\'s special sweet, puliyogare, is served as prasadam' },
        ],
    ...
    Mysuru: {
        cards: [
            { image: WIKI('1/1e/Mysore_Palace_Night.jpg/1280px-Mysore_Palace_Night.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600100393203-5ba9541df13c?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Mysore Palace Majesty', text: 'The Amba Vilas Palace, built in 1912, is one of India\'s most spectacular royal residences. Its Indo-Saracenic architecture, stained glass, and intricate woodwork dazzle 6 million visitors annually.', alt: 'Mysore Palace illuminated' },
            { image: WIKI('d/d0/Mysore_ambari.jpg/1280px-Mysore_ambari.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1499002238440-d264edd596ec?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Dasara Festivities', text: 'Mysore Dasara is a 10-day festival celebrating the victory of good over evil. The illuminated palace, caparisoned elephants, and cultural processions make it India\'s most regal festival.', alt: 'Mysore Dasara procession' },
            { image: WIKI('1/12/Nandi_at_chamundi_mysore.jpg/1280px-Nandi_at_chamundi_mysore.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Chamundi Hills Journey', text: 'Rising 1,030 metres above Mysore, Chamundi Hill is crowned by the Chamundeshwari Temple. The 1,000-step climb passes a giant Nandi statue and offers views of the entire city.', alt: 'Chamundi hill Nandi statue' },
        ],
        travel: [
            { destination: 'Mysore Palace', image: WIKI('b/bf/Dome_inside_Mysore_Palace.jpg/1280px-Dome_inside_Mysore_Palace.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Visit the royal palace at night when it is illuminated with 97,000 lights. The Sunday illumination is particularly spectacular, especially during Dasara.', bestTime: 'Year-round, especially Sundays and Dasara season', tip: 'The palace\'s Durbar Hall with its stained-glass ceiling is breathtaking' },
            { destination: 'Brindavan Gardens', image: WIKI('0/02/Brindavan_garden_night_view.jpg/1280px-Brindavan_garden_night_view.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1759220948579-aa4866af0f0d?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Terraced gardens with illuminated fountains, musical water shows, and manicured lawns overlooking the KRS Dam reservoir.', bestTime: 'October to May', tip: 'The night lighting and musical fountain show (7 PM) is a must-see' },
    ...
    Raichur: {
        cards: [
            { image: WIKI('f/fa/Raichur_Fort_3.jpg/1280px-Raichur_Fort_3.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1775489876620-6611994afd43?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Raichur Fort\'s Defence', text: 'Perched on a 117-metre rock, Raichur Fort changed hands between Vijayanagara and Bahmani kingdoms. The fort\'s massive cannon, one of India\'s largest, still guards the entrance.', alt: 'Raichur fort cannon' },
            { image: IMG('photo-1504639725590-34d0984388bd'), title: 'Krishna-Tungabhadra Confluence', text: 'The sacred meeting of the Krishna and Tungabhadra rivers creates a fertile landscape. The Kudalasangama Sangameshwara Temple at the confluence is a major pilgrimage site.', alt: 'Krishna Tungabhadra confluence' },
        ...
        travel: [
            { destination: 'Raichur Fort', image: WIKI('f/fa/Raichur_Fort_3.jpg/1280px-Raichur_Fort_3.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Explore the historic fort with its massive ramparts, ancient cannons, and panoramic views of the Krishna River valley and Raichur city.', bestTime: 'October to March', tip: 'The fort\'s cannon (Top-e-Bahadur) is 4.5 metres long — one of India\'s largest' },
    ...
    Ramanagara: {
        cards: [
            { image: WIKI('f/f9/Revanasiddeshwara_temple.jpg/1280px-Revanasiddeshwara_temple.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Ramadevara Betta', text: 'The iconic rocky hill where the Bollywood classic "Sholay" was filmed. The 800-year-old Ramadevara Temple on the hill was Gabbar Singh\'s den in the movie.', alt: 'Ramadevara Betta Sholay' },
    ...
    Shivamogga: {
        cards: [
            { image: WIKI('5/57/Jog_Falls-_Raja%2C_Rani_%2C_Rocket_%2C_Roarer.jpg/1280px-Jog_Falls-_Raja%2C_Rani_%2C_Rocket_%2C_Roarer.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1600965962272-3b5e1a2e0a0a?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Jog Falls\' Thunder', text: 'India\'s second-highest plunge waterfall at 830 feet, Jog Falls is segmented into four cascades — Raja, Rani, Rover, and Rocket. During monsoon, they merge into one roaring curtain.', alt: 'Jog Falls monsoon cascade' },
            ...
            { image: WIKI('6/60/Kavaledurga_Fort_Entrance_Trails.JPG/1280px-Kavaledurga_Fort_Entrance_Trails.JPG'), fallbackImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Kavaledurga Fort Trek', text: 'A 14th-century fort atop a rocky hill surrounded by dense forest. The 4-km trek through the Western Ghats passes streams, spice gardens, and ancient gateways.', alt: 'Kavaledurga fort trek' },
        ],
        travel: [
    ...
    Tumakuru: {
        cards: [
            { image: WIKI('1/1d/Basava_and_Shivakumara_Swami_Relief_in_Siddaganga_matha_Tumakur_2.jpg/1280px-Basava_and_Shivakumara_Swami_Relief_in_Siddaganga_matha_Tumakur_2.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1771250851493-a156fb0a6b85?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Siddaganga Math', text: 'One of Karnataka\'s most revered spiritual institutions, the Siddaganga Math has been a centre of learning for 900 years. The math runs a free residential school for thousands of students.', alt: 'Siddaganga Math Tumakuru' },
            { image: WIKI('3/35/Devarayanadurga_01.jpg/1280px-Devarayanadurga_01.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Devarayanadurga Hills', text: 'A scenic hill range with temples, a massive Nandi statue, and panoramic views. The 9-km forest trek passes boulders and shrines to reach the hilltop Bhoga Narasimha Temple.', alt: 'Devarayanadurga hills trek' },
            { image: WIKI('f/fc/Shivagange_hill%2Cbangalore.jpg/1280px-Shivagange_hill%2Cbangalore.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1748671631643-87e9ce7aa917?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Shivaganga Hill', text: 'Known as "Dakshina Kashi" (Varanasi of the South), this 1,374-metre peak is crowned by a temple. The Honna Devi water stream is believed to have healing properties.', alt: 'Shivaganga hill temple' },
        ],
        travel: [
    ...
    Udupi: {
        cards: [
            { image: WIKI('8/89/Udupi_Sri_krishna_matha_Temple_pond.jpg/1280px-Udupi_Sri_krishna_matha_Temple_pond.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Krishna Math Heritage', text: 'The 13th-century Krishna Math founded by Madhvacharya is Udupi\'s spiritual heart. The unique window (Navagraha Kindi) through which Lord Krishna is worshipped is world-famous.', alt: 'Udupi Krishna Math temple' },
        ...
        travel: [
            ...
            { destination: 'Malpe Beach', image: IMG('photo-1505118380757-91f5f5632de0'), description: 'Relax on pristine golden sands, go dolphin spotting, or take a boat to St. Mary\'s Island. The beach is lined with palm trees and seafood shacks.', bestTime: 'October to March', tip: 'Dolphin sightings are most common in the early morning' },
    ...
    UttaraKannada: {
        cards: [
            { image: WIKI('b/b7/Gokarna_main_beach%2C_February%2C_2018.jpg/1280px-Gokarna_main_beach%2C_February%2C_2018.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Gokarna\'s Sacred Shores', text: 'Gokarna is both a pilgrimage town and a beach paradise. The Mahabaleshwar Temple houses a revered atmalinga, while Om Beach and Half Moon Beach offer pristine sands.', alt: 'Gokarna beach temple' },
            { image: WIKI('6/6e/Dandeli_river_rafting.jpg/1280px-Dandeli_river_rafting.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Dandeli\'s Wild River', text: 'The Kali River through Dandeli offers India\'s best white-water rafting. The surrounding forest of the Dandeli Wildlife Sanctuary teems with wildlife and bird species.', alt: 'Dandeli river rafting' },
    ...
    Vijayanagara: {
        cards: [
            { image: PEX(29623825), title: 'Hampi — Empire of Ruins', text: 'The Vijayanagara Empire\'s capital was once among the world\'s largest cities. Today its 1,600+ ruins — royal pavilions, temples, and bazaars — sprawl across a stark boulder landscape, whispering tales of a lost civilization.', alt: 'Hampi ruins Vijayanagara empire' },
            { image: IMG('photo-1775489876620-6611994afd43'), title: 'Virupaksha Temple\'s Living Faith', text: 'Dedicated to Lord Shiva, this 7th-century temple has been in continuous use longer than almost any other in India. Its 50-metre gopuram and pillared halls still echo with daily puja hymns.', alt: 'Virupaksha temple gopuram Hampi' },
            { image: IMG('photo-1748671631643-87e9ce7aa917'), title: 'Tungabhadra Dam & Gardens', text: 'The massive dam across the Tungabhadra River irrigates millions of acres. The terraced Mughal-style gardens below offer boat rides, musical fountains, and sweeping sunset views over the reservoir.', alt: 'Tungabhadra dam gardens' },
        ],
        travel: [
            { destination: 'Hampi Bazaar & Royal Enclosure', image: IMG('photo-1506905925346-21bda4d32df4'), description: 'Walk the mile-long market street that once traded diamonds and silk. The adjacent Royal Enclosure contains the Mahanavami Dibba, the Queen\'s Bath, and the Lotus Mahal.', bestTime: 'October to March', tip: 'Rent a bicycle to cover the vast site — it\'s the best way to explore' },
            { destination: 'Daroji Sloth Bear Sanctuary', image: IMG('photo-1511497584788-876760111969'), description: 'India\'s first sloth bear sanctuary, protecting the endangered bear in its natural habitat. The sanctuary is also home to leopards, wolves, and over 100 bird species.', bestTime: 'October to May', tip: 'Early morning safaris offer the best chance to spot bears emerging from caves' },
            { destination: 'Anjeyanadri Hill', image: IMG('photo-1464822759023-fed622ff2c3b'), description: 'Believed to be the birthplace of Lord Hanuman, this hill offers a 575-step climb to a small temple at the top. The 360° view of the Hampi basin is breathtaking.', bestTime: 'October to February', tip: 'Start the climb 30 minutes before sunset for golden light over the ruins' },
        ],
        tips: ['Hampi is vast — plan at least 2 full days to explore', 'Carry 2+ litres of water and wear a hat at all times', 'The boulder landscape is surreal at sunrise and sunset', 'Hire a local guide for the mythological stories behind the ruins', 'Combine with a coracle ride on the Tungabhadra River'],
    },

    Vijayapura: {
        cards: [
            { image: WIKI('3/3f/Gol_Gumbaz%2C_Bijapur%2C_Karnataka_-2.jpg/1280px-Gol_Gumbaz%2C_Bijapur%2C_Karnataka_-2.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1775489876620-6611994afd43?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Gol Gumbaz\'s Whispering Wonders', text: 'The mausoleum of Muhammad Adil Shah, Gol Gumbaz features one of the world\'s largest domes — 38 metres in diameter. The whispering gallery carries sound across 37 metres.', alt: 'Gol Gumbaz dome Vijayapura' },
            { image: WIKI('0/09/IBRAHIM_ROZA_VIJAYPURA.jpg/1280px-IBRAHIM_ROZA_VIJAYPURA.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1748671631643-87e9ce7aa917?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Ibrahim Roza\'s Elegance', text: 'Often described as the "Taj Mahal of the Deccan," this mausoleum of Ibrahim Adil Shah II is a masterpiece of symmetry and proportion. The intricate stonework is breathtaking.', alt: 'Ibrahim Roza Vijayapura' },
        ...
        travel: [
            { destination: 'Gol Gumbaz', image: WIKI('3/3f/Gol_Gumbaz%2C_Bijapur%2C_Karnataka_-2.jpg/1280px-Gol_Gumbaz%2C_Bijapur%2C_Karnataka_-2.jpg'), fallbackImage: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?fm=jpg&q=60&w=1200&auto=format&fit=crop', description: 'Marvel at the massive dome — the second largest pre-modern dome in the world after St Peter\'s Basilica. The whispering gallery is a must-experience acoustic wonder.', bestTime: 'October to March', tip: 'Clap in the whispering gallery — the echo repeats 7 times' },
    ...
    Yadgir: {
        cards: [
            { image: WIKI('2/2c/Yadgir_Fort.png/1280px-Yadgir_Fort.png'), fallbackImage: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?fm=jpg&q=60&w=1200&auto=format&fit=crop', title: 'Yadgir Fort\'s Heights', text: 'Perched on massive granite boulders, Yadgir Fort offers panoramic views of the surrounding plains. The fort\'s strategic location made it a coveted prize for successive Deccan empires.', alt: 'Yadgir fort granite boulders' },
